...
- 의결권 NFT를 신규 발급하거나 이미 발급된 특정 NFT를 무효화하는 것
- 밈토큰을 신규 발행하는 것
...
PDAO는 아직 정식 런치가 되지 않은 상태이며, 2022년 여름 동안 다음을 진행할 예정입니다.
...
<img src="./10com.png" alt="The Ten Commandments" width="800"/>
...
더 나아가 블록체인이라는 신생 패러다임을 대학 차원에서 과감하게 수용하는 혁신적인 전략의 채택을 할 수 있도록 도울 것입니다.
