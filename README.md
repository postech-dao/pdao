...
5. 대학 자체의 본격적인 크립토 채택을 촉진
   - 대학 발전기금을 암호화폐 기부 받고 보유, 매매하는 프로세스 리서치 및 제안
...
5. 밈토큰, NFT, 게임 등 탈중앙화 애플리케이션과 직접 연계가 가능합니다.

## DAO는 어떻게 운영됩니까?

- 자체 체인인 **PBC** (PDAO Beacon Chain)이 DAO의 핵심 주체입니다.
...
- PDAO에 있어서 PBC는 5가지로 작용합니다.
   ...
   4. 멀티체인 상호운용성
   5. 분산 파일 스토리지
- 동문과 교수를 대상으로, 충분한 기여를 보인 사람은 의결권을 체인 상에서 의결을 통해 지급하며, 이를 분실하거나 해당 멤버가 부적절한 일을 하였을 때에도 마찬가지로 의결을 통해 무효화됩니다.
- PBC에서 가버넌스와 컨센서스를 거쳐 의결이 된 내용은 영구히 기록되며 멤버들이 운영하는 노드에 검증가능한 방법으로 분산저장됩니다.
- PBC에서 의결된 내용은 신뢰하는 3자의 도움 없이도 다른 상용체인에서 암호학적으로 검증가능 합니다. 이를 통해 PDAO는 **멀티체인 DAO**의 성격을 가집니다. Treasury나 밈토큰와 같은 PDAO의 탈중앙화 애플리케이션은 이더리움, 솔라나, 코스모스, 니어, 폴카닷 등의 다양한 체인에 배치되고, 이를 PBC에서 일괄적으로 관리하면서 다양한 체인의 생태계에 진출하게 됩니다.

### DAO는 무엇을 의결할 수 있습니까?

- 재단의 자산을 집행하기 위해 DAO 컨트랙트에서 출금하는 것
- 재단의 자산을 운용하기 위해 특정 DeFi 서비스에 예치하는 것
